      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            {darkmode ? <img src={LogoDark} className="h-8" alt="FilmBase Logo Dark" /> : <img src={Logo} className="h-8" alt="FilmBase Logo" />}
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FilmBase</span>
          </Link>
          <div className="flex md:order-2">
            <button onClick={() => setDarkmode(!darkmode)} type="button" data-collapse-toggle="sun" aria-controls="navbar-search" aria-expanded="false" className=" text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-2">
