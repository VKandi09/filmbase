        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          { movie.genres ? (
            ...
            { movie.genres.map((genre) => (
              <span className="mr-2 border border-gray-200 rounded dar:border-gray-600 p-2" key={genre.id}>{genre.name}</span>
            ))}
            </p>
          ) : "" }
          ...
          <p className="my-4">
            <span className="my-2 mr-2 font-bold">Runtime:</span>
            <span>{movie.runtime} min.</span>
          </p>
          <p className="my-4">
            <span className="my-2 mr-2 font-bold">Budget:</span>
            <span>{movie.budget}</span>
          </p>
          <p className="my-4">
            <span className="my-2 mr-2 font-bold">Revenue:</span>
            <span>{movie.revenue}</span>
          </p>
          <p className="my-4">
            <span className="my-2 mr-2 font-bold">Release Date:</span>
            <span>{movie.release_date}</span>
          </p>
          <p className="my-4">
            <span className="my-2 mr-2 font-bold">IMDB Code:</span>
